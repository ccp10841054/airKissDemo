...
#ifndef LarkAirKissDefines_h
#define LarkAirKissDefines_h
...
typedef NS_ENUM(NSInteger,LarkAirKissFailType) {
    LarkAirKissFailTypeForSendWifi = 0, //发送wifi
    LarkAirKissFailTypeForSendToken = 1, //发送token
};
